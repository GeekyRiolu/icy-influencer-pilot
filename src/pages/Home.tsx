    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          {/* Logo/Brand */}
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-primary rounded-full mb-8 shadow-purple">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            <Badge variant="secondary" className="px-4 py-2 bg-muted border-border">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <Card key={index} className="bg-card border-border shadow-soft hover:shadow-purple transition-all duration-300 group">
        ...
        <div className="max-w-4xl mx-auto mt-20">
          <Card className="bg-gradient-primary text-white shadow-purple border-0">
